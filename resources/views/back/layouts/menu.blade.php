            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('admin.config.index')}}" class="nav-link  @if(Request::segment(2)=='config') active @endif">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('admin.meqale.index')}}" class="nav-link @if(Request::segment(2)=='meqale') active @endif">
...
{{--                                <i class="far fa-newspaper nav-icon"></i>--}}
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="#" class="nav-link  @if(Request::segment(2)=='menu') active @endif">
